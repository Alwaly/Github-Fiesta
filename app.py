...
x_test.to_csv('${{ github.workspace }}/x_test.csv', index=False)
x_train.to_csv('${{ github.workspace }}/x_train.csv', index=False)
y_test.to_csv('${{ github.workspace }}/y_test.csv', index=False)
y_train.to_csv('${{ github.workspace }}/y_train.csv', index=False)